    ...
    public class HKCamera
    {
        ...
        public bool ContinuousMode
        {
            ...
            set
            {
                ...
                if (value)
                {
                    _myCamera.MV_CC_SetEnumValue_NET("TriggerMode", 0);
                }
                else
                {
                    _myCamera.MV_CC_SetEnumValue_NET("TriggerMode", 1);
                }
            }
        }
        ...
        /// <summary>
        /// The user defined name or the serial number of the camera
        /// </summary>
        ...
        /// </summary>
        public event Action<HImage> OnImageAcquired;
        ...
        public bool Open(out string message)
        {
            ...
            ret = _myCamera.MV_CC_RegisterImageCallBackEx_NET(ImageCallback, IntPtr.Zero);
            if (ret != 0)
            {
                message = "Register image acquisition call back failed";
                _myCamera.MV_CC_DestroyDevice_NET();
                return false;
            }
            ...
            if (CameraType == CameraType.Gige)
            {
                ...
                if (optimalSize > 0)
                {
                    ...
                    {
                        message = "Warning: set packet size failed";
                    }
                }
                else
                {
                    message = "Warning: get packet size failed";
                }
            }
        ...
        public bool GrabStop()
        {
            ...
            if (success) IsGrabbing = false;
            return success;
        }

        /// <summary>
        /// Whether the camera is in grabbing mode
        /// </summary>
        ...
        protected virtual void OnOnImageAcquired(HImage obj)
        {
            OnImageAcquired?.Invoke(obj);
        }
